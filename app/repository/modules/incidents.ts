...
import {
  ...
  fetchSupabaseIncidentUpdateNotesIndex,
...
class IncidentsModule {
  ...
  async getUpdateNotesIndex(): Promise<Record<string, string>> {
    this.assertConfigured()
    return await fetchSupabaseIncidentUpdateNotesIndex(this.client)
  }
